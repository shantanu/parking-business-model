...
def get_cash_flow(sales, commission, cost):
    return sales - commission - cost
...
def get_yearly_valuation(
    valuation_params: ValuationParams, monthly_cumulative_cash_flow: list[float]
) -> list[float]:
    return [
        discount(
